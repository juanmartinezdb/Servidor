...
-- Insertar un equipo usando solo el año (se completa con 1 de enero por defecto)
INSERT INTO equipos (nombreEquipo, fechaCreacion)
VALUES ('AC Milan', CONCAT(2025, '-01-01'));


-- Actualizar la fecha de creación de un equipo usando solo el año
UPDATE equipos
SET fechaCreacion = CONCAT(2026, '-01-01')
WHERE nombreEquipo = 'AC Milan';
